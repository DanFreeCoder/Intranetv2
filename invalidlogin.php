                ...
                <div class="col-md-6">
                   <div class="panel panel-success">
                       <div class="panel-heading">
                         <h6 class="panel-title">Portal Login</h6>
                       </div>
                      <div class="panel-body">
                         <div class="alert alert-danger">
                         Please key-in your Password again!
                         The username or password is incorrect.(make sure your caps lock is off).
                         </div>
                         <form name="search" method="post">
                         <div class="form-group">
                        <input type="text" class="form-control input-sm" id="username" placeholder="Username" required="">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control input-sm" id="password" placeholder="Password" required="">
                    </div>
                    <button id="login" type="submit" class="btn btn-success btn-sm" style="float:right;">Sign In</button>
                </form>
                      </div>
                   </div>
                   <a style="COLOR:GREEN" href="step1.php"><b>Forgot Password?</b></a><br><br>
                 </div>
               </div> <!-- row -->
