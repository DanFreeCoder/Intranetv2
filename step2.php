                   ...
                   <div class="panel panel-success">
                      ...
                      <div class="panel-body">
                         <div class="alert alert-success" id="okay">
                          ...
                          You almost have it. Please complete the verification below.
                         </div>
                         <div class="alert alert-danger" id="danger">
                          Ooops, Sorry. Your verification code you entered is incorrect. Please check your email again.
                         </div>
                         <form name="search" method="post" action="/innogroupv2/controls/login.php">
                         <div class="form-group">
                         &nbsp;Enter <b>verification code </b> that was sent to your email...
                         </div>
                        <div class="form-group">
                         <input type="text" class="form-control input-sm" id="code" placeholder="example:0107" required="">
                        </div>
                    <a class="btn btn-success btn-sm" style="float:right;" href="step3.php" id = "verifcode">Submit</a>
                </form>
                      </div>
                   </div>
